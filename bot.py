...
async def send_channel_hit(res, uid, username, name):
    try:
        ...
        if sv in ["CHARGED", "APPROVED"]:
            ...
            status_emoji = gemj("hit_channel_emoji")
...
<b>━━━━━━━━━━━━━━━━━</b>
𝗗𝗲𝘃 → sonik"""
            HIT_BUTTON = [[Button.url(f"{gemj('rocket')} {bs('Sonik')}", f"https://t.me/{MAIN_BOT_USERNAME}")]]
            await styled_send(HIT_CHANNEL_ID, msg, buttons=HIT_BUTTON, emoji_ids=[CE["hit_channel_emoji"]])
    except:
        pass
